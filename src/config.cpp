...
Configuration::PhysicsParameters const &Configuration::GoalKeeperPhysicsParameters() const {
    return goal_keeper_params_;
}

Configuration::PhysicsParameters const &Configuration::FootballerPhysicsParameters() const {
